...
def main():
    ...
    menu = ["Xem danh sách món",
            ...
            "Xóa món theo tên",
            "Xóa món theo ID",
            "Sửa giá món theo tên",
            "Sửa giá món theo ID",
            "Sửa trạng thái món theo tên",
    ...
    while True:
        ...
        if choice not in range(1,17):
            ...
            handle_update_food_price_by_id(manager)

        elif choice == 9:
            handle_update_food_available(manager)
        
        elif choice == 10:
            handle_update_food_available_by_id(manager)
